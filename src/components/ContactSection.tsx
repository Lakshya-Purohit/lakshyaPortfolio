...
const socials = [
    {
        label: 'GitHub',
        url: 'https://github.com/Lakshya-Purohit',
        icon: (
    ...
    {
        label: 'LinkedIn',
        url: 'https://www.linkedin.com/in/lakshya-purohit-a472a6200/',
        icon: (
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        label: 'Resume',
        url: 'https://docs.google.com/document/d/1QXMsRv8-HO6GgMjwXDKBD6rv7IirnCnm5zZBYpnHftI/export?format=pdf',
        icon: (
